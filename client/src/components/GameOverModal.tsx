...
export function GameOverModal({ open, game, onPlayAgain, isDaily, onClose }: GameOverModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="w-[95vw] sm:max-w-xl bg-card border-white/10 shadow-2xl p-2 sm:p-4 rounded-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-2 sm:p-4 border border-primary/20">
        ...
        <DialogFooter className="sm:justify-center gap-2 pt-2 sm:pt-4">
          {isDaily ? (
