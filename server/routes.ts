...
const COMPANIES_SEED = [
  ...
  { symbol: "ACL", name: "Amcor PLC", sector: "Materials", subIndustry: "Paper & Forest Products", headquarters: "Melbourne, Australia", founded: "1860", description: "A global leader in responsible packaging solutions that protects products and uses less materials.", marketCap: "$15B" },
